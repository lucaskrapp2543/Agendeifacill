...
interface Establishment {
  ...
  // affiliate_link?: string; // Temporariamente removido até aplicar migração
}
  ...
  const handleUpdateEstablishment = async (e: React.FormEvent) => {
    ...
    try {
      const establishmentData = {
        ...
        profile_image: profileImage
        // affiliate_link: affiliateLink.trim() // Temporariamente removido até aplicar migração
      };
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        if (establishments) {
          ...
          // setAffiliateLink(establishments.affiliate_link || ''); // Temporariamente removido até aplicar migração
