-- SOLUÇÃO SIMPLES: Acesso administrativo que FUNCIONA
...
-- Comentário
COMMENT ON FUNCTION get_establishment_for_admin(UUID) IS 'Obtém dados do estabelecimento para acesso administrativo';
