...
-- Política para estabelecimentos verem suas notificações
...
-- Política para estabelecimentos inserirem suas notificações
...
-- Política para estabelecimentos atualizarem suas notificações
...
-- Política para estabelecimentos deletarem suas notificações
...
-- Função para criar notificação automaticamente quando agendamento é criado
...
-- Trigger para criar notificação quando agendamento é criado
...
-- Trigger para criar notificação quando agendamento é cancelado
