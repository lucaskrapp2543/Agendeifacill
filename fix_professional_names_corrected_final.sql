-- CORRIGIR NOMES DOS PROFISSIONAIS (VERSÃO FINAL CORRIGIDA)
...
-- 2. Ver os profissionais no JSON (versão corrigida)
SELECT 
  e.id as establishment_id,
  e.name as establishment_name,
  json_array_elements(e.professionals::json) as professional_data
