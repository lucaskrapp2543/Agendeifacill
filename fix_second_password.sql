-- CORREÇÃO DO SISTEMA DE SEGUNDA SENHA
...
-- Função corrigida para criar/atualizar segunda senha
...
BEGIN
  ...
  -- Atualizar a segunda senha (especificando a tabela)
  UPDATE establishments 
  SET second_password = $2
  WHERE id = $1;
