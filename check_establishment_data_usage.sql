...
-- Este SQL vai mostrar o tamanho exato em MB/KB usado por esta conta

-- 1. Buscar o establishment_id da conta estabelecimento02@gmail.com
WITH establishment_data AS (
  SELECT id, name, email, created_at
  FROM establishments 
  WHERE email = 'estabelecimento02@gmail.com'
),

-- 2. Calcular tamanho das tabelas relacionadas a este establishment
data_usage AS (
  SELECT 
