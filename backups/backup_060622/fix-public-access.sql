...
-- 4. Criar dados de teste para agendamentos (para reproduzir o problema)
-- Vamos criar agendamentos que causam o conflito que o usuário reportou
...
-- Agendamento às 09:00 (30 min) - vai até 09:30
('00000000-0000-0000-0000-000000000001', 
 (SELECT id FROM establishments WHERE code = '1010' LIMIT 1),
 'Corte Masculino',
 'rodrigo',
 '2025-06-12',  -- Ajuste para uma data futura
 '09:00',
 'confirmed',
 'Cliente Teste 1',
 25.00,
...
-- Agendamento às 09:15 (45 min) - vai até 10:00  
...
SELECT 'Agendamentos de teste criados!' as status;
SELECT appointment_time, duration, service, professional, appointment_date 
FROM appointments 
WHERE appointment_date = '2025-06-12' 
ORDER BY appointment_time;

-- 5. Explicação do teste:
-- Com esses agendamentos:
-- - 09:00-09:30 (ocupado)
-- - 09:15-10:00 (ocupado) 
-- 
-- O horário 08:30 NÃO deveria estar disponível para um serviço de 45min
-- porque 08:30 + 45min = 09:15, que conflita com o agendamento das 09:00
--
-- O sistema deve bloquear 08:30 quando o serviço selecionado for de 45min 