...
export const RefreshButton = () => {
  ...
  return (
    <button
      ...
      className="fixed bottom-32 right-4 sm:bottom-20 sm:right-6 z-30 bg-black hover:bg-gray-800 text-white px-3 py-2.5 rounded-xl shadow-lg transition-all transform hover:scale-105 active:scale-95 disabled:opacity-50 disabled:cursor-not-allowed inline-flex items-center gap-1.5 min-w-[112px] justify-center"
