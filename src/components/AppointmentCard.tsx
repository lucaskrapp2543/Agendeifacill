...
export const AppointmentCard = ({
  ...
  return (
    <div className={`${appointment.status === 'cancelled' ? 'bg-red-800/90' : 'bg-green-800/90'
      ...
      <div className="flex justify-between items-start">
        ...
        <div className={`px-2 py-1 rounded text-sm ${appointment.status === 'confirmed' ? 'bg-green-500/20 text-green-500' :
        ...
        <div className="border-t border-gray-700 pt-4">
          <div className="flex justify-between items-center">
            ...
            <div>
              ...
              <p className={`text-sm ${appointment.pix_payment_status === 'confirmado' ? 'text-green-500' :
