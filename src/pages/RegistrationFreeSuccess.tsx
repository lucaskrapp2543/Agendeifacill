...
const RegistrationFreeSuccess: React.FC = () => {
  return (
      ...
      <div className="max-w-md w-full">
        ...
        <div className="bg-white rounded-3xl shadow-2xl p-8 text-center">
          ...
          <div className="space-y-4">
            {/* Botão Ativar Conta de Teste */}
            <a
              href="https://wa.me/5548991265320?text=Quero%20ativar%20minha%20conta%20de%20teste%20do%20Agendei%20Fácil"
              target="_blank"
...
export default RegistrationFreeSuccess;
