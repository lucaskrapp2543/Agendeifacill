-- Enforce blocked_hours at database level.
-- Prevents booking on blocked professional times even if frontend misses validation.
...
BEGIN
  ...
  LOOP
    ...
    -- Keep compatibility with legacy 15-minute blocked slots.
